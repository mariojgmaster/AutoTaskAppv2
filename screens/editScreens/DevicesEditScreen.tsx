...
function Item({ id, name, active, turnedOn, idUser, idDepartment, path, nav }) {
    ...
    const saveDeviceChanges = async (id, idUsuario, idDepartamento, devicePath) => {
        let payload = {
            id: id,
        ...
        console.log(payload);
        console.log('---');
        let res = await axios.put(`${Api.EndPoint.URL}/equipamentos/${id}`, payload);
        let data = res.data;
        console.log(data);
    ...
    const deleteDevice = async id => {
        let res = await axios.delete(`${Api.EndPoint.URL}/equipamentos/${id}`);
        let data = res.data;
        console.log(data);
